...
new_dir = Path(r"C:\Users\edmun\Desktop\VSCode Projects\Yonder\Yonder-CV-Experimenting\datasets\val2017")
...
def add_coco_data(new_dir):
    ...
    for idx, file in enumerate(new_dir.glob("*")):
        ...
        if idx < 750: save_dir = 'train' 
        elif idx < 1000: save_dir = 'valid'
        else: break
            #save_dir = 'test'

        shutil.copy(file, rf"C:\Users\edmun\Desktop\VSCode Projects\Yonder\Yonder-CV-Experimenting\datasets\sc_uni_dataset\{save_dir}\images")
        with open(rf"C:\Users\edmun\Desktop\VSCode Projects\Yonder\Yonder-CV-Experimenting\datasets\sc_uni_dataset\{save_dir}\labels\{file_name}", 'w') as file: pass
        print(idx)
