...
def add_coco_data(new_dir):
    ...
    for idx, file in enumerate(new_dir.glob("*")):
        ...
        shutil.copy(file, rf"C:\Users\edmun\VSC_DIRS\Yonder-CV-Experimenting\datasets\january_data\{save_dir}\images")
        with open(rf"C:\Users\edmun\VSC_DIRS\Yonder-CV-Experimenting\datasets\january_data\{save_dir}\labels\{file_name}", 'w') as file: pass
        print(idx)
